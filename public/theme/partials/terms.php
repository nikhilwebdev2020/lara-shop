<div class="terms">
    <h5> <i>Terms and Conditions</i> </h5>
    ...
    your web browser, IP address, time zone, and some of the cookies that are installed on your device. Additionally, as
    you browse the Site, we collect information about the individual web pages or products that you view, what websites
    or search terms referred you to the Site, and information about how you interact with the Site. We refer to this
    ...
    - <b>“Cookies”</b> are data files that are placed on your device or computer and often include an anonymous unique
    identifier. For more information about cookies, and how to disable cookies, visit http://www.allaboutcookies.org.
    <br>
    - <b>“Log files”</b> track actions occurring on the Site, and collect data including your IP address, browser type,
    Internet service provider, referring/exit pages, and date/time stamps. <br>
    - <b>“Web beacons,” “tags,” and “pixels”</b> are electronic files used to record information about how you browse
    the Site.
    ...
    numbers, esewa account imgormation), email address, and phone number. We refer to this information as “Order
    Information.”
    <br>
    ...
    Information here: <a href="https://policies.google.com/privacy?hl=en"
        target="_blank">https://policies.google.com/privacy?hl=en</a>. <br>
    We also use Google Analytics to help us understand how our customers use the Site.
    <br>
    Finally, we may also share your Personal Information to comhttps://policies.google.com/privacy?hl=enply with
    applicable laws and regulations, to respond to a subpoena, search warrant or other lawful request for information we
    ...
    You can opt out of targeted advertising by reaching setting for Facebook Ad, Google Ad etc.

    <hr>
    <b>DO NOT TRACK</b> <br>
    Please note that we do not alter our Site’s data collection and use practices when we see a Do Not Track signal from
    your browser.
    ...
    please contact us by e-mail at sastoshowroom@gmail.com or by visiting us using the details provided below:

    Tinkuney, Kathmandu, 00977, Nepal <br><br>
