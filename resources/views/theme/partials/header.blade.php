...
<head>
    ...
    <title>{{ isset($title) ? $title : 'Home' }} | Maxine Blooms</title>

    <link rel="icon" href="{{ asset('theme/logosmall.ico') }}" type="image/x-icon">

    <link rel="stylesheet" href="{{ asset('theme/css/style.css?ver=4.1') }}">
    <link rel="stylesheet" href="{{ asset('theme/css/media.css?ver=4.1') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">

    <link rel="stylesheet" href="https://unpkg.com/flickity@2/dist/flickity.min.css">
    <link rel="stylesheet" href="{{ asset('theme/owlcarousel/dist/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/owlcarousel/dist/assets/owl.theme.default.min.css') }}">
