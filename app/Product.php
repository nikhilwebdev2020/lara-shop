...
class Product extends Model
{
    public function scopeNotsuspended($query){
      ...
      public static function productSales($count = 3)
      {
          ...
          $products = Product::notsuspended()->where('discountPercent', '>', 0)->inRandomOrder()->get()->take($count);
      ...
      public static function productMostBought($count = 3)
      {
          ...
          $products = Product::notsuspended()->orderBy('totalSoldQuantity', 'DESC')->get()->take($count);
      ...
      // new
      public static function recentProductsCategories_new($count = 5)
      {
      ...
      public static function productSales_new($count = 3)
      {
  
          $products = Product::where('discountPercent', '>', 0)->inRandomOrder()->get()->take($count);
      ...
      public static function productMostBought_new($count = 3)
      {
